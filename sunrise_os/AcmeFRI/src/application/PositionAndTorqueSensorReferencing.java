 ...
 */
public class PositionAndTorqueSensorReferencing extends RoboticsAPIApplication {
    ...
    public void run()
    {
        ...
        if (allAxesMastered)
        {
            ...
            // Adjust for small workspace
            // NOTE: PositionAndGMSReferencing works at 50% override, but this new point #3 still doesn't work
            // System doesn't like -150 or +150 for J1
            performMotion(new JointPosition(Math.toRadians(80.0),
                                            Math.toRadians(-15.76),
...
*/
            ...
            performMotion(new JointPosition(Math.toRadians(-9.01),
                                            Math.toRadians(45.00),
                                            Math.toRadians(24.72),
                                            Math.toRadians(82.04),
                                            Math.toRadians(104.65),
    ...
    public static void main(String[] args) {
        PositionAndTorqueSensorReferencing app = new PositionAndTorqueSensorReferencing();
        app.runApplication();
    }
}
